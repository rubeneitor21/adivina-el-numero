...
public class CharacterRuben extends ObjectRuben {
  ...
  public CharacterRuben(String name, String texturePath, float x, float y, float width, float height, int rows,
      int cols) {
    super(name, texturePath, x, y, width, height, rows, cols);
  }
